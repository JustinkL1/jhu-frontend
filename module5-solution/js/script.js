...
(function (global) {
  ...
  dc.loadAboutRating = function () {
    showLoading("#main-content");
    $ajaxUtils.sendGetRequest(allCategoriesUrl, buildShowRatingHTML);
  };

  // Builds HTML for the about rating page based on the random rating
  function buildShowRatingHTML() {
    $ajaxUtils.sendGetRequest(
      aboutRatingHtml,
  ...
  // Choose a random rating from 1 to 5 inclusively
